...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__http_service__ = __webpack_require__(303);
...
var HomePage = (function () {
    ...
    HomePage.prototype.ngOnInit = function () {
        ...
        this.drawMap();
        //this.loadPeople();
        this.data.load().subscribe(function (res) { return _this.user = res; }, function (err) { return console.log(err); }, function () { return console.log('done'); });
        console.log(this.user);
    };
    HomePage.prototype.drawMap = function () {
        //let map = Leaflet.map('map');
        var map = __WEBPACK_IMPORTED_MODULE_4_leaflet__["map"]('map', {
        ...
        __WEBPACK_IMPORTED_MODULE_4_leaflet__["marker"]([51.5, -0.09]).addTo(map);
        //alert("hey!")
    };
    HomePage.prototype.loadPeople = function () {
        var _this = this;
        this.httpService.load()
            .then(function (data) {
            _this.users = data;
        });
    };
...
HomePage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__http_service__["a" /* HttpService */], __WEBPACK_IMPORTED_MODULE_3__data__["a" /* Data */]])
], HomePage);
...
var Data = (function () {
    ...
    Data.prototype.load = function () {
        return this.http.get('http://localhost:8100/api/user')
            .map(function (res) { return res.json(); });
    };
    return Data;
}());
